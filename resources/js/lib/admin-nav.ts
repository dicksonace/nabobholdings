...
export function adminNavGroups(active: AdminNavKey, role: string = 'admin'): PanelNavGroup[] {
    ...
    groups.push({
        ...
        items: isAdmin
            ...
            : [{ key: 'categories', label: 'Categories', href: route('admin.categories.index'), mobile: true, defaultOnPath: true }],
    });
    ...
    groups.push({
        ...
        items: [
            ...(isAdmin
                ...
                : [{ key: 'orders-all', label: 'All orders', href: route('admin.orders.index'), mobile: true, defaultOnPath: true }]),
            {
    ...
    groups.push({
        ...
        items: [
            ...
            ...(isAdmin ? [{ key: 'reviews', label: 'Product Reviews', href: route('manage.reviews.index') }] : []),
        ],
    });
    ...
    if (isAdmin) {
        groups.push({
            ...
            items: [
                { key: 'brand', label: 'Brand, Currency & Contact', href: route('admin.brand.settings') },
                { key: 'staff', label: 'Staff accounts', href: route('admin.staff.index') },
            ],
        });
    }
